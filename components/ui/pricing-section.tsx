...
function SubscribeButton() {
  ...
  return (
    <Button
      type="submit"
      disabled={pending}
      className="w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-md flex items-center justify-center py-3"
    >
      {pending ? (
        <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-card rounded-xl shadow-md overflow-hidden max-w-5xl mx-auto">
          ...
          <div className="p-8 md:flex">
            ...
            <div className="md:w-1/2 md:border-l md:border-border md:pl-8 pt-6 md:pt-0">
